                    ...
                    <div className="items-center w-full my-auto max-w-md px-6 mx-auto lg:w-2/6">
                        <div className="flex-1">
                            <div className="text-center">
                                <div className="" >
                                    <img className="w-20 lg:w-36 h-12 lg:h-20 mx-auto" src="https://i.ibb.co.com/RHhNn7v/logo.png" alt="" />
                                </div>
                            ...
                            <div className="mt-8">
                                ...
                                <p className="mt-6 text-sm text-center text-sky-700">Don't have an account yet? <Link href={"/register"} className="text-blue-500 focus:outline-none focus:underline hover:underline">Sign up</Link>.</p>
                            </div>
                        </div>
                    </div>

                    <div className="bg-cover hidden md:block md:w-full  lg:w-2/5" style={{ backgroundImage: "url(https://i.ibb.co.com/ngW6qjg/pexels-photo-1081685.webp)" }}>
